// src/components/Graph/CombinedStateTimelineGraph/utils.js
...
export function toMinutes(timeStr) {
  ...
  export function buildLineData(entries, timeline) {
    ...
    // סינון אחרון – רק ערכים עם מספר דקות ותחושה חוקית
    return data.filter(d => d && d.timeMinutes !== undefined && d.feeling !== undefined);
  }
